...
const signTurnDurationDefault = 1 * 60; // 1 minutes
const signTurnNoWorkDefault = 10; // 10 seconds
const defaultTimeoutDefault = 5 * 60; // 5 minutes
const defaultCacheThresholdTTL = 1 * 60; // 1 minutes
